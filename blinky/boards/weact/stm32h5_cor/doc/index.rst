.. zephyr:board:: weact_stm32h5_cor

Overview
********

The ``weact_stm32h5_cor`` board is a compact development board equipped with
...
The ``weact_stm32h5_cor`` board provides the following hardware components:
...
The ``weact_stm32h5_cor`` board is configured as follows
...
The ``weact_stm32h5_cor`` board facilitates firmware flashing via the USB DFU
...
Flashing an application to ``weact_stm32h5_cor``
-------------------------------------------------
...
Testing the LEDs in the ``weact_stm32h5_cor``
**********************************************
...
:zephyr_file:`boards/weact/stm32h5_core/weact_stm32h5_cor.dts`.

Testing shell over USB in the ``weact_stm32h5_cor``
****************************************************
